...
public class TabSegmentScrollableModeFragment extends BaseFragment {
    ...
    protected View onCreateView() {
        ...
        mQDItemDescription = DataManager.getInstance().getDescription(this.getClass());
        initTopBar();
        initTabAndPager();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        getLazyViewLifecycleOwner().getLifecycle().addObserver(new LazyTestObserver("QDTabSegment"));
    }
